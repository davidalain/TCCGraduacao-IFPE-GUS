...
%Numeração contínua das figuras e tabelas (Figura 1, Tabela 1...), sem o número do capítulo.
%O \mainmatter da classe memoir reativa a numeração por capítulo,
%por isso a redefinição do comando interno que ele chama.
\makeatletter
...
\usepackage[automake,nonumberlist,nopostdot]{glossaries}
\makeglossaries
% Estilo personalizado para a lista de abreviações
\newglossarystyle{abreviacoes}{
    \setglossarystyle{long}

    \renewenvironment{theglossary}
        {\begin{longtable}{@{}p{2.5cm}p{\dimexpr\textwidth-2.5cm\relax}@{}}}
        {\end{longtable}}
